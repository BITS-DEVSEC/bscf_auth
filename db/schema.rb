...
ActiveRecord::Schema[8.0].define(version: 2025_07_20_184059) do
  ...
  create_table "bscf_core_loan_repayments", force: :cascade do |t|
    ...
    t.date "payment_date", default: "2025-07-23", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "bscf_core_loans", force: :cascade do |t|
    ...
    t.bigint "disbursement_transaction_id", null: false
    t.float "principal_amount", default: 0.0, null: false
    t.float "interest_amount", default: 0.0, null: false
    t.float "unpaid_balance", default: 0.0, null: false
    t.integer "status", default: 0, null: false
    t.date "due_date", default: "2025-08-07", null: false
    t.date "paid_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "bscf_core_orders", "bscf_core_delivery_orders", column: "delivery_order_id"
  ...
  add_foreign_key "bscf_core_virtual_account_transactions", "bscf_core_virtual_account_transactions", column: "paired_transaction_id"
  add_foreign_key "bscf_core_virtual_account_transactions", "bscf_core_virtual_accounts", column: "account_id"
